...
def get_args():
    ...
    parser.add_argument('--total_num_scenes', type=str, default="auto")             #Scene corresponds to an independent world/environment which the agent explores parallel to other scenes
    parser.add_argument('-n', '--num_processes', type=int, default=5,               #Process corresponds to a single thread that loads one or more scenes. If there are 4 threads and 8 scenes, each thread runs 2 scenes (sequentially within a thread and parallely amongst threads)
